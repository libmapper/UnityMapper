...
{
    public List<IBoundProperty> ExtractProperties(AudioSource component)
    {
        return [new VolumeProperty(component), new PitchProperty(component)];
    }
}

internal class VolumeProperty(AudioSource component) : IBoundProperty
{
...
internal class PitchProperty(AudioSource component) : IBoundProperty
{
    public Type GetMappedType()
    {
        return typeof(float);
